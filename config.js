...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'DENNIS;BIG BROTHER;https://i.imgur.com/SvoILq6.jpeg;https://chat.whatsapp.com/JBmn87Li6a9H7n7NCaDYU8',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.',
    STICKER_DATA: process.env.STICKER_DATA || "BIG BROTHER",
    BOT_NAME: process.env.BOT_NAME || 'DENNIS BOT',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "public" ? 'BIG BROTHER;DENNIS BOT MD bot;https://i.imgur.com/SvoILq6.jpeg' : process.env.AUDIO_DATA,
    ...
    SUDO: process.env.SUDO || "2347018087851",
